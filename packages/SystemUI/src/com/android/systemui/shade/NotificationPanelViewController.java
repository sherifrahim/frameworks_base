...
import com.android.systemui.derp.NotificationLightsView;
...
public final class NotificationPanelViewController extends PanelViewController {
    ...
    private void updateNotificationTranslucency() {
        ...
        boolean invisible = mBarState != StatusBarState.KEYGUARD && !isFullyCollapsed() 
            || !isPanelVisibleBecauseOfHeadsUp();
        mCentralSurfaces.updateDismissAllVisibility(invisible);
    }

    ...
    public static class QSLayoutUtils {
        ...
        public static boolean updateLayout(Context context) {
            ...
            for (int i = 0; i < 2; ++i) {
                String pkgName;
                if (i == 0) {
                    pkgName = String.format("org.derpfest.qs.portrait.layout_%sx%s", Integer.toString(row_qs), Integer.toString(col_qs));
                } else {
                    pkgName = String.format("org.derpfest.qqs.portrait.layout_%sx%s", Integer.toString(row_qqs), Integer.toString(col_qs));
                }
                try {
